...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc1339c5ee915ebc0: (a: number, b: number) => void;
export const closure1472_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure1984_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure2171_externref_shim: (a: number, b: number, c: any) => void;
