...
export const closure1475_externref_shim: (a: number, b: number, c: any) => void;
export const closure1990_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure1987_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure2174_externref_shim: (a: number, b: number, c: any) => void;
