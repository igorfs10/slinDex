...
export const closure1409_externref_shim: (a: number, b: number, c: any) => void;
export const closure1924_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure1921_externref_shim: (a: number, b: number, c: any, d: any) => void;
