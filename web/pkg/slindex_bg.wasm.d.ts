...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1ced39da98bc1fb8: (a: number, b: number) => void;
export const closure1473_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure1985_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure2172_externref_shim: (a: number, b: number, c: any) => void;
