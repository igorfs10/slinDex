...
export interface InitOutput {
  ...
  readonly closure1882_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure1879_externref_shim: (a: number, b: number, c: any, d: any) => void;
  readonly closure2066_externref_shim: (a: number, b: number, c: any) => void;
