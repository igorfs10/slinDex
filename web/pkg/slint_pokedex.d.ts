...
export interface InitOutput {
  ...
  readonly closure1687_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure1684_externref_shim: (a: number, b: number, c: any, d: any) => void;
  readonly closure1871_externref_shim: (a: number, b: number, c: any) => void;
