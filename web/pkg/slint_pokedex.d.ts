...
export interface InitOutput {
  ...
  readonly closure1280_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1794_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure1791_externref_shim: (a: number, b: number, c: any, d: any) => void;
  readonly closure1978_externref_shim: (a: number, b: number, c: any) => void;
