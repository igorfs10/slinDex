...
export const closure1368_externref_shim: (a: number, b: number, c: any) => void;
export const closure1882_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure1879_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure2066_externref_shim: (a: number, b: number, c: any) => void;
